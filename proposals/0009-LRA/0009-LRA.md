...
the lifecycle of and participation in LRAs and a forth API for writing participants:
...
This set of APIs means that the specification will usable in a wider variety of systems:
...
#### Scenario 1:
  ...
  Kill the coordinator before closing the LR
